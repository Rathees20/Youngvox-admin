...
import { Mail, Lock, LogIn, ShieldCheck, UserCircle } from 'lucide-react';
import { cn } from '../utils/cn';

const ChapterChiefLogin = () => {
  ...
  const handleLogin = (e) => {
    ...
    // Chapter Chief authentication logic
    setTimeout(() => {
      if (email === 'chief@youngvox.com' && password === 'chief123') {
        ...
        setError('Invalid credentials for Chapter Chief. Use chief@youngvox.com / chief123');
        setIsLoading(false);
      }
    }, 1000);
  };
      ...
      <div className="w-full max-w-[450px] space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            <h1 className="text-[32px] font-[900] text-[#1a1a1a] tracking-tight">Chapter Chief</h1>
            <p className="text-[14px] font-black text-[#555555] opacity-50 uppercase tracking-widest">Portal Access</p>
          </div>
        </div>
        ...
        <div className="bg-white p-10 rounded-[32px] shadow-[0_32px_64px_rgba(0,0,0,0.03)] border border-[#eeeeee]">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  placeholder="chief@youngvox.com"
          ...
          <div className="mt-8 pt-8 border-t border-[#eeeeee] flex flex-col items-center gap-4">
             <div className="flex items-center justify-center gap-2">
                <p className="text-[13px] font-bold text-[#555555]">Are you a mentor?</p>
                <button 
                  onClick={() => navigate('/login')}
                  className="text-[13px] font-black text-[#c72030] hover:underline transition-all"
                >
                  Mentor Login
                </button>
             </div>
        ...
        <p className="text-center text-[12px] font-black text-[#555555] opacity-30 tracking-tight uppercase">
          © 2026 YoungVox Admin • Chapter Chief Portal
        </p>
      </div>
    </div>
  );
...
export default ChapterChiefLogin;
