        ...
        {reportCards.map((card, idx) => (
          <div key={idx} className="bg-white rounded-2xl p-4 shadow-sm border border-[#eeeeee] flex flex-col gap-4 group hover:shadow-2xl hover:shadow-dark/5 transition-all duration-500 relative overflow-hidden">
             ...
             <div className="flex items-center gap-3 mt-auto">
                <button className="flex-1 flex items-center justify-center gap-2 bg-gray-50 hover:bg-white border border-transparent hover:border-gray-100 py-3.5 rounded-2xl text-[12px] font-normal text-[#555555] transition-all">
