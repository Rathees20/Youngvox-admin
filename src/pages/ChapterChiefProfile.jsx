            ...
            <div className="pt-6 md:pl-36 flex flex-col lg:flex-row justify-between items-start gap-8">
              ...
              <div className="flex flex-col gap-8 flex-1">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <p className="text-[14px] font-normal text-[#555555] opacity-60">Chapter Chief</p>
        ...
        <div className="bg-[#fff9ed] border border-[#ffecce]/50 rounded-[32px] p-8 flex flex-col xl:flex-row gap-10">
          ...
          <div className="flex-1 flex flex-col">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-8">
              ...
              <div className="flex flex-col items-center md:items-start md:ml-auto md:pt-4">
                <div className="flex items-center gap-2 text-[#1caf5f] text-[14px] font-bold mb-2">
                  <TrendingUp size={18} strokeWidth={3} />
                  Up from #5
                </div>
                <span className="bg-[#e7f6ed] text-[#1caf5f] text-[11px] font-bold px-3 py-1 rounded-md">Top 8%</span>
              </div>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-wrap gap-x-12 gap-y-3">
                <div className="flex items-center gap-2">
                  <div className="w-2.5 h-2.5 rounded-full bg-[#c72030]" />
          ...
          <div className="xl:w-[350px] flex items-center justify-center">
            <div className="bg-white rounded-[24px] p-8 shadow-[0_10px_40px_rgba(0,0,0,0.02)] border border-gray-50 w-full flex flex-col items-center text-center gap-6">
              ...
              <button className="w-full border border-[#c72030] text-[#c72030] text-[13px] font-bold py-3 px-6 rounded-xl hover:bg-[#c72030] hover:text-white transition-all duration-300 active:scale-95">
                Recognition Badges
              </button>
            </div>
          </div>
