...
import { Search, ChevronDown, Filter, Calendar, TrendingUp, TrendingDown, MoreHorizontal, User } from 'lucide-react';
...
const Analytics = () => {
  ...
  return (
    <div className="p-4 max-w-7xl mx-auto space-y-6 animate-in fade-in duration-700">
      ...
      {/* Main Chart Section */}
      <div className="bg-white rounded-3xl p-8 border border-[#eeeeee] shadow-sm space-y-8">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-3">
             <div className="w-6 h-6 rounded-full border-2 border-[#A82228] flex items-center justify-center p-0.5">
             ...
             <h3 className="text-[16px] font-normal text-[#1a1a1a]">Assessment Analytics (Our School Vs 50 schools average)</h3>
          </div>
          <div className="flex items-center gap-3">
             <div className="relative">
                <select className="appearance-none bg-white border border-[#eeeeee] rounded-xl py-2 px-5 pr-10 text-[12px] font-normal text-[#555555] outline-none cursor-pointer">
        ...
        {/* Bar Chart Container */}
        <div className="relative h-[320px] w-full mt-8">
          {/* Y-Axis */}
          ...
          <div className="flex justify-center gap-8 mt-12 pt-4">
             ...
             <div className="flex items-center gap-2">
                ...
                <span className="text-[12px] font-normal text-[#1a1a1a]">50 schools average</span>
             </div>
          </div>
        </div>
            ...
            <div key={idx} className="bg-gray-50/50 rounded-2xl p-5 border border-transparent hover:border-[#eeeeee] transition-all">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center text-[12px]">
                   <span className="text-[#555555] opacity-50">50 schools average:</span>
                   <span className="text-[#1a1a1a]">{insight.avg}</span>
                </div>
                <div className="flex justify-between items-center text-[12px]">
                   <span className="text-[#555555] opacity-50">Our School:</span>
      ...
      <div className="bg-white rounded-3xl p-8 border border-[#eeeeee] shadow-sm space-y-6">
        ...
        {/* Filter Toolbar */}
        <div className="bg-gray-50/30 border border-[#eeeeee] rounded-2xl p-5 space-y-4">
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-end pt-8">
           <div className="flex-1 w-full h-[240px] border-l border-b border-gray-100 flex items-end justify-center px-8 relative">
              <div className="absolute inset-0 flex flex-col justify-between pointer-events-none">
                 <div className="w-full h-px border-t border-gray-50 border-dashed" />
                 <div className="w-full h-px border-t border-gray-50 border-dashed" />
                 <div className="w-full h-px border-t border-gray-50 border-dashed" />
           ...
           <div className="lg:w-[320px] bg-gray-50/50 border border-[#eeeeee] rounded-2xl p-6 space-y-5">
              <h4 className="text-[14px] font-normal text-[#1a1a1a]">Academic & career</h4>
              <div className="space-y-4">
                 <div className="flex justify-between items-center">
                    <span className="text-[12px] font-normal text-[#555555] opacity-50 tracking-tighter uppercase">Pre - assessment response:</span>
                    <span className="text-[14px] font-normal text-[#1a1a1a]">58</span>
                 </div>
                 <div className="flex justify-between items-center">
                    <span className="text-[12px] font-normal text-[#555555] opacity-50 tracking-tighter uppercase">Post - assessment response:</span>
