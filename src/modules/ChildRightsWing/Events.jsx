...
import { ChevronDown, Calendar, Clock, User, ChevronRight } from 'lucide-react';
...
const ChildRightsWingEvents = () => {
  const events = [
    { title: 'Child Rights Awareness Session', wing: 'Child Rights & Social Justice', deadline: '1/15/2026', time: '5:00 AM', image: '/images/Image (Training Event).png', status: 'Upcoming', type: 'Monthly Event' },
    { title: 'Child Rights Awareness Session', wing: 'Child Rights & Social Justice', deadline: '1/15/2026', time: '5:00 AM', image: '/images/Image (Training Event).png', status: 'Upcoming', type: 'Monthly Event' },
    { title: 'Child Rights Awareness Session', wing: 'Child Rights & Social Justice', deadline: '1/15/2026', time: '5:00 AM', image: '/images/Image (Training Event).png', status: 'Upcoming', type: 'Monthly Event' },
  ];
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12 relative z-10">
          ...
          <div className="flex-1 space-y-6 text-center lg:text-left">
            ...
            <p className="text-[14px] font-normal text-[#555555] opacity-80 leading-relaxed max-w-2xl">
              Join us for an intensive training session. Limited slots available!
            </p>
...
export default ChildRightsWingEvents;
