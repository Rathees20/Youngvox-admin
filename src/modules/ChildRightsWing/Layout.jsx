...
import ChildRightsWingSidebar from './Sidebar';
import Header from '../../components/Header';
import { cn } from '../../utils/cn';

const ChildRightsWingLayout = ({ children }) => {
  ...
  return (
    <div className="flex min-h-screen w-full bg-[#f7f7f8] selection:bg-primary/10 font-['Arial']">
      ...
      <aside className={cn(
        ...
        <ChildRightsWingSidebar onClose={() => setIsMobileMenuOpen(false)} />
      </aside>
...
export default ChildRightsWingLayout;
