...
const ChildRightsWingAnalytics = () => {
  const stats = [
  ...
  const categories = [
    { title: 'Child Rights Awareness', avg: '58%', school: '50%', improvement: '+24% improvement' },
    { title: 'Safety & Protection', avg: '62%', school: '75%', improvement: '+23% improvement' },
    { title: 'Social Justice Education', avg: '55%', school: '78%', improvement: '+23% improvement' },
    { title: 'Peer Advocacy', avg: '60%', school: '87%', improvement: '+27% improvement' },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 pt-8">
          <div className="lg:col-span-2 relative min-h-[350px]">
             ...
             <div className="relative h-full flex items-end justify-center ml-20 gap-8 pb-10">
                <div className="flex flex-col items-center gap-4">
                  ...
                  <p className="text-[13px] font-normal text-[#555555]/40 uppercase tracking-[2px] mt-4">Child Rights</p>
                </div>
             </div>
          </div>
          ...
          <div className="flex flex-col justify-center">
            <div className="bg-[#f8f9fa] rounded-[32px] p-8 border border-gray-100/50 space-y-6 group hover:bg-white hover:shadow-xl transition-all duration-500">
              <h4 className="text-[16px] font-normal text-[#1a1a1a] tracking-tight">Child Rights & Safety</h4>
...
export default ChildRightsWingAnalytics;
