...
import { Search, ChevronDown, Filter, Bell, MoreVertical } from 'lucide-react';

const AcademicWingMembers = () => {
  const [searchQuery, setSearchQuery] = useState('');

  const members = [
    { id: 'AJ', name: 'Esther Howard', email: 'alice.j@school.edu', role: 'Wing Leader - Academic & Career Guidance', status: 'active', performance: 95, color: '#1caf5f' },
    { id: 'BM', name: 'Bob Martinez', email: 'bob.m@school.edu', role: 'Wing Leader - Academic & Career Guidance', status: 'active', performance: 88, color: '#f59e0b' },
    { id: 'CD', name: 'Carol Davis', email: 'carol.d@school.edu', role: 'Wing Leader - Academic & Career Guidance', status: 'warning', performance: 65, color: '#ef4444' },
    { id: 'DC', name: 'David Chen', email: 'david.c@school.edu', role: 'Wing Leader - Academic & Career Guidance', status: 'active', performance: 98, color: '#1caf5f' },
    ...
    { id: 'FT', name: 'Frank Thompson', email: 'frank.t@school.edu', role: 'Wing Leader - Academic & Career Guidance', status: 'active', performance: 85, color: '#f59e0b' },
    { id: 'GL', name: 'Grace Lee', email: 'grace.l@school.edu', role: 'Wing Leader - Academic & Career Guidance', status: 'active', performance: 94, color: '#1caf5f' },
    { id: 'LA', name: 'Leslie Alexander', email: 'leslie.a@school.edu', role: 'Wing Leader - Academic & Career Guidance', status: 'active', performance: 94, color: '#1caf5f' },
  ];
  ...
  return (
    <div className="min-h-screen bg-white animate-in fade-in duration-700 font-['Arial']">
      ...
      <div className="p-6 space-y-6 max-w-[1600px] mx-auto w-full font-['Arial'] min-h-screen bg-white">
        {/* Title and Intro */}
            ...
            <table className="w-full border-collapse min-w-[1000px]">
              ...
              <tbody className="divide-y divide-gray-50">
                {members.map((member) => (
                  <tr 
                    key={member.id}
                    className="transition-all duration-300 hover:bg-[#fbfbfc] group"
                  >
...
export default AcademicWingMembers;
