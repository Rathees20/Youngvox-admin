...
const AcademicWingReports = () => {
  const reports = [
    { 
      title: 'Career Bingo', 
      wing: 'Academic & Career Guidance', 
      subtext: 'SDG 3 - Good Health & Well-being',
  ...
  const chartData = [
    { label: 'Academic & career', value: 65, color: 'bg-[#b8d8ff]' },
    { label: 'Student Wellbeing', value: 45, color: 'bg-[#b2ffd1]' },
            ...
            {chartData.map((bar, idx) => (
              <div key={idx} className="flex flex-col items-center gap-6 w-1/4 max-w-[200px] h-full justify-end group">
                ...
                <div className="relative w-full px-4 flex justify-center items-end h-[300px]">
                   <div 
                    className={cn(
                      "w-3/4 rounded-t-lg transition-all duration-1000 ease-out shadow-sm",
                      bar.color
                    )}
...
export default AcademicWingReports;
