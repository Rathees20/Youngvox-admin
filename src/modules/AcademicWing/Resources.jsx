...
const ResourceCard = ({ title, wing, sdg, activity, deadline }) => (
  <div className="bg-white rounded-[24px] p-6 shadow-sm border border-gray-100 group hover:shadow-xl transition-all duration-300 space-y-5">
    <div className="space-y-2">
      ...
      {sdg && (
        <p className="text-[11px] font-normal text-[#e11d48] tracking-tight">{sdg}</p>
      )}
    </div>
    ...
    <div className="space-y-4">
      <div className="space-y-2">
        <p className="text-[12px] font-normal text-[#1a1a1a] tracking-tight">Activity Guideline</p>
      ...
      <div className="space-y-2">
        <p className="text-[12px] font-normal text-[#1a1a1a] tracking-tight">Report Submission Guideline</p>
        <button className="w-full flex items-center justify-center gap-2 bg-white border border-gray-100 py-2.5 rounded-xl text-[12px] font-normal text-[#555555] hover:bg-gray-50 transition-all group/btn">
          <Download size={14} className="group-hover/btn:scale-110 transition-transform" />
          Download PDF
        </button>
...
const ManualCard = ({ title, size, type = "PDF" }) => (
  <div className="bg-white rounded-[24px] p-5 border border-gray-100 flex items-center justify-between group hover:shadow-xl transition-all duration-300">
    ...
    <button className="flex items-center gap-2 text-[#A82228] hover:bg-[#A82228] hover:text-white px-5 py-2.5 rounded-xl text-[12px] font-normal border border-[#A82228]/10 bg-[#A82228]/5 transition-all group/btn">
      <Download size={14} />
      Download
    </button>
  </div>
...
const AcademicWingResources = () => {
  const resources = [
    { title: 'Career Bingo', wing: 'Academic & Career Guidance', sdg: 'SDG 3 - Good Health & Well-being', activity: 'Annual flagship program', deadline: '11/11/2024' },
    { title: 'Career Bingo', wing: 'Academic & Career Guidance', sdg: 'SDG 3 - Good Health & Well-being', activity: 'Annual flagship program', deadline: '11/11/2024' },
    { title: 'Career Bingo', wing: 'Academic & Career Guidance', sdg: 'SDG 3 - Good Health & Well-being', activity: 'Annual flagship program', deadline: '11/11/2024' },
    { title: 'Career Bingo', wing: 'Academic & Career Guidance', sdg: 'SDG 3 - Good Health & Well-being', activity: 'Annual flagship program', deadline: '11/11/2024' },
    { title: 'Career Bingo', wing: 'Academic & Career Guidance', sdg: 'SDG 3 - Good Health & Well-being', activity: 'Annual flagship program', deadline: '11/11/2024' },
  ...
  const manuals = [
    { title: 'Chapter Formation Guideline', size: '2.3 MB' },
    { title: 'Student Activity Guidelines', size: '1.1 MB' },
    { title: 'Teacher Activity Guidelines', size: '850 KB' },
    { title: 'Code of conduct', size: '1.5 MB' },
    { title: 'Child safety and protection policies', size: '980 KB' },
  ];
  ...
  return (
    <div className="p-6 space-y-6 animate-in fade-in duration-700 pb-24 max-w-[1600px] mx-auto font-['Arial'] bg-white min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-6">
        <div className="space-y-1">
          <h2 className="text-[20px] font-normal text-[#1a1a1a] tracking-tight">Resource Library</h2>
          <p className="text-[13px] font-normal text-[#555555] opacity-60">Access all your activity templates and guidelines</p>
        </div>
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 bg-white border border-gray-100 px-5 py-3 rounded-2xl text-[13px] font-normal text-[#555555] shadow-sm hover:bg-gray-50 transition-all relative">
            <div className="absolute -top-1 -right-1 w-5 h-5 bg-[#A82228] text-white text-[10px] flex items-center justify-center rounded-full border-2 border-white">2</div>
            <Bell size={18} />
            Updates
          </button>
      ...
      <div className="bg-[#fff1f2]/60 rounded-[40px] p-8 md:p-10 border border-[#fecdd3]/50 space-y-8">
        <div className="flex items-center gap-4">
          ...
          <h3 className="text-[18px] font-normal text-[#1a1a1a] tracking-tight">Manuals</h3>
        </div>
...
export default AcademicWingResources;
