...
import WellbeingWingSidebar from './Sidebar';
import Header from '../../components/Header';
import { cn } from '../../utils/cn';

const WellbeingWingLayout = ({ children }) => {
  ...
  return (
    <div className="flex min-h-screen w-full bg-[#f7f7f8] selection:bg-primary/10 font-['Arial']">
      ...
      <aside className={cn(
        ...
        <WellbeingWingSidebar onClose={() => setIsMobileMenuOpen(false)} />
      </aside>
...
export default WellbeingWingLayout;
