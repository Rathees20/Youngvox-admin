...
const WellbeingWingReports = () => {
  const reports = [
    { title: 'Mental Health Workshop', wing: 'Student Wellbeing', subtext: 'SDG 3 - Good Health & Well-being', activity: 'Annual flagship program', date: '11/11/2024', submittedBy: 'Sarah Miller', status: 'Completed' },
    { title: 'Stress Management Program', wing: 'Student Wellbeing', activity: 'Monthly poster activity', date: '11/11/2024', submittedBy: 'Sarah Miller', status: 'Review' },
    { title: 'Mental Health Workshop', wing: 'Student Wellbeing', subtext: 'SDG 3 - Good Health & Well-being', activity: 'Annual flagship program', date: '11/11/2024', submittedBy: 'Sarah Miller', status: 'Completed' },
    { title: 'Stress Management Program', wing: 'Student Wellbeing', activity: 'Monthly poster activity', date: '11/11/2024', submittedBy: 'Sarah Miller', status: 'Review' },
    { title: 'Stress Management Program', wing: 'Student Wellbeing', activity: 'Monthly poster activity', date: '11/11/2024', submittedBy: 'Sarah Miller', status: 'Review' },
    { title: 'Stress Management Program', wing: 'Student Wellbeing', activity: 'Monthly poster activity', date: '11/11/2024', submittedBy: 'Sarah Miller', status: 'Review' },
  ...
  const chartData = [
    ...
    { label: 'Child Rights & Safety', value: 78, color: 'bg-[#e9d5ff]', highlight: true },
...
export default WellbeingWingReports;
