...
import ChapterChiefSidebar from '../components/ChapterChiefSidebar';
import Header from '../components/Header';
import { cn } from '../utils/cn';

const ChapterChiefLayout = ({ children }) => {
  ...
  return (
    <div className="flex min-h-screen w-full bg-[#f7f7f8] selection:bg-primary/10">
      ...
      <aside className={cn(
        ...
        <ChapterChiefSidebar onClose={() => setIsMobileMenuOpen(false)} />
      </aside>
...
export default ChapterChiefLayout;
